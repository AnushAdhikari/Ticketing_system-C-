    ...
    public partial class AddVisitors : UserControl
    {
        ...
        private void btnVisitorSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (group == 0)
                {
                    MessageBox.Show("Please select Group", "Invalid!!",
                       MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
